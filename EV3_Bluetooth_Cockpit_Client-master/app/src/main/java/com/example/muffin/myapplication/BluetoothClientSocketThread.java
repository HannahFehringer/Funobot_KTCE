...
public class BluetoothClientSocketThread implements Runnable {
    ...
    public BluetoothClientSocketThread(MainActivity currentActivity, BluetoothDevice btDevice) {
        ...
        m_os = null;
        m_buf = null;
        m_handler = new BlueToothMessageHandler(m_currentActivity);
