...
class BluetoothPairedDevicesDialogOnClickListener implements DialogInterface.OnClickListener {
    ...
    public BluetoothPairedDevicesDialogOnClickListener(MainActivity currentActivity, BluetoothDevice[] devices) {
        m_btDevices = devices;
        m_currentActivity = currentActivity;
    }

    public void connect(BluetoothDevice btDevice) {
        Thread t = new Thread(m_currentActivity.m_btMain = new BluetoothClientSocketThread(m_currentActivity, btDevice));
        t.start();
    }
...
public class BluetoothPairedDevicesDialog extends DialogFragment {
    ...
    public BluetoothPairedDevicesDialog initialize(MainActivity currentActivity, Set<BluetoothDevice> btDevices) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dBuilder.setItems(btDeviceNames, new BluetoothPairedDevicesDialogOnClickListener(m_currentActivity, btArr));
